import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, ref, computed, unref, defineAsyncComponent, Suspense, nextTick, mergeProps, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "D:/test-code/nuxt-crm/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/test-code/nuxt-crm/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/test-code/nuxt-crm/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/test-code/nuxt-crm/node_modules/h3/dist/index.mjs";
import { shouldHydrate, createPinia, setActivePinia } from "pinia";
import { defu } from "D:/test-code/nuxt-crm/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "D:/test-code/nuxt-crm/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-CZfbqQby.js")
  },
  {
    name: "leads",
    path: "/leads",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/leads-BFeSKCiL.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/login-CmIEH7oc.js")
  },
  {
    name: "contacts",
    path: "/contacts",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/contacts-BdT5mNyj.js")
  },
  {
    name: "settings",
    path: "/settings",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/settings-CGd4WyDd.js")
  },
  {
    name: "customers",
    path: "/customers",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/customers-DsdRID9r.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/dashboard-CoyewQ3G.js")
  },
  {
    name: "opportunities",
    path: "/opportunities",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/opportunities-B0-fDnob.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-BfJNpEGy.js")
};
...
const layouts = {
  auth: defineAsyncComponent(() => import("./_nuxt/auth-Dk-N1jD1.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-DXbh1xfp.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-3k4KG6gS.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-WkjZloqI.js"));
...
export {
  defineNuxtRouteMiddleware as A,
  useRoute as B,
  _export_sfc as _,
  useNuxtApp as a,
