import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, computed, unref, ref, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, toRaw, useSSRContext, isRef, isShallow, isReactive } from 'vue';
import { p as parseURL, e as encodePath, m as decodePath, n as hasProtocol, o as isScriptProtocol, q as joinURL, w as withQuery, r as sanitizeStatusCode, v as getContext, $ as $fetch, x as defu, y as createHooks, h as createError$1, z as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-CZfbqQby.mjs')
  },
  {
    name: "leads",
    path: "/leads",
    meta: { "middleware": "auth" },
    component: () => import('./leads-BFeSKCiL.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-CmIEH7oc.mjs')
  },
  {
    name: "contacts",
    path: "/contacts",
    meta: { "middleware": "auth" },
    component: () => import('./contacts-BdT5mNyj.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    meta: { "middleware": "auth" },
    component: () => import('./settings-CGd4WyDd.mjs')
  },
  {
    name: "customers",
    path: "/customers",
    meta: { "middleware": "auth" },
    component: () => import('./customers-DsdRID9r.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import('./dashboard-CoyewQ3G.mjs')
  },
  {
    name: "opportunities",
    path: "/opportunities",
    meta: { "middleware": "auth" },
    component: () => import('./opportunities-B0-fDnob.mjs')
  }
];
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-Dk-N1jD1.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-DXbh1xfp.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-3k4KG6gS.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-WkjZloqI.mjs'));
...
export { defineNuxtRouteMiddleware as A, useRoute as B, _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useNamespace as d, entry_default as default, encodeRoutePath as e, isNumber as f, isBoolean as g, throwError as h, isUndefined as i, isPropAbsent as j, isElement as k, debugWarn as l, isStringNumber as m, navigateTo as n, useZIndex as o, defaultInitialZIndex as p, namespaceContextKey as q, resolveRouteObject as r, useGetDerivedNamespace as s, tryUseNuxtApp as t, useRouter as u, useIdInjection as v, useId as w, isWindow as x, isEmpty as y, zIndexContextKey as z };
